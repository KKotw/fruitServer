<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"/var/www/html/fruit_machine/application/cms/view/fruit_common_configs/info.html";i:1481021467;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_header.html";i:1481021471;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_footer.html";i:1481021471;}*/ ?>
...
<!-- input -->
                        <div class="cms_right_box2_write_group1">
                            ...
                            <div class="cms_right_box2_write_group1_inner1">      
                                <input  id="description" name="description" type="text" value='<?php echo (isset($info['description']) && ($info['description'] !== '')?$info['description']:''); ?>' disabled/>
                            </div>
                        </div>
<!-- 多图上传展示 -->
                        ...
                        <div class="cms_right_box2_write_group1">
                            ...
                            <div class="cms_right_box2_write_group1_inner1">
                                <input id="type" name="type" type="text" value="<?php if($info['type']==0): ?>string<?php elseif($info['type']==1): ?>bannerUrl<?php elseif($info['type']==2): ?>file<?php else: ?>files<?php endif; ?>" disabled/>
                            </div>
                        </div>
