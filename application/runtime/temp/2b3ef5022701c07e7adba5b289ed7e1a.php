<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/var/www/html/fruit_machine/application/cms/view/fruit_machine/edit.html";i:1481021468;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_header.html";i:1481021471;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_footer.html";i:1481021471;}*/ ?>
...
<!-- input -->
                        <div class="cms_right_box2_write_group1">
                            ...
                            <div class="cms_right_box2_write_group1_inner1">      
                                <input  id="contact_name" name="contact_name" type="text" value='<?php echo (isset($info['contact_name']) && ($info['contact_name'] !== '')?$info['contact_name']:''); ?>' />
                            </div>
                        </div>
<!-- input -->
                        <div class="cms_right_box2_write_group1">
                            ...
                            <div class="cms_right_box2_write_group1_inner1">      
                                <input  id="contact_mobile" name="contact_mobile" type="text" value='<?php echo (isset($info['contact_mobile']) && ($info['contact_mobile'] !== '')?$info['contact_mobile']:''); ?>' />
                            </div>
                        </div>
<!-- input -->
                        <div class="cms_right_box2_write_group1">
                            ...
                            <div class="cms_right_box2_write_group1_inner1">      
                                <input  id="contact_address" name="contact_address" type="text" value='<?php echo (isset($info['contact_address']) && ($info['contact_address'] !== '')?$info['contact_address']:''); ?>' />
                            </div>
                        </div>
<!-- input -->
                        <div class="cms_right_box2_write_group1">
                            ...
                            <div class="cms_right_box2_write_group1_inner1">      
                                <input  id="mac" name="mac" type="text" value='<?php echo (isset($info['mac']) && ($info['mac'] !== '')?$info['mac']:''); ?>' />
                            </div>
                        </div>
                        <div class="cms_right_box2_write_group1">
                            ...
                            <div class="cms_right_box2_write_group1_inner1">
                                <select id='is_delete' name = 'is_delete' readonly="readonly">
                                    ...
                                    <option value="1" <?php echo ($info['is_delete']==1)?'selected' :''; ?>>删除</option>
                                </select>
                            </div>
                        </div>
        ...
        function initSaveBtn() {
            $("#saveBtn").bind("click", function(){
                if ($("#editForm").valid()) {
                    ...
                    if(!myreg.test($("#contact_mobile").val()))
                    {
                        alert('请输入有效的手机号码！');
                        return false;
                    }
