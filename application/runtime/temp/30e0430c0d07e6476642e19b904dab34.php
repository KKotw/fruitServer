<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"/var/www/html/fruit_machine/application/cms/view/fruit_location/index.html";i:1481021468;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_header.html";i:1481021471;s:80:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_pager.html";i:1481021471;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_footer.html";i:1481021471;}*/ ?>
	...
	$('.showLoginout').click(function(){
            ...
            <div class="cms_right_box1">
                <form id="searchFrom" action='<?php echo U("index"); ?>' method='get'>
                    ...
                    <div class="cms_right_box1_inner">
                        ...
                        <em><span>货架ID</span><input name="machine_id" value='<?php echo (isset($searchCnd['machine_id']) && ($searchCnd['machine_id'] !== '')?$searchCnd['machine_id']:""); ?>'></em>
                        <em><span>货架名</span><input name="machine_name" value='<?php echo (isset($searchCnd['machine_name']) && ($searchCnd['machine_name'] !== '')?$searchCnd['machine_name']:""); ?>'></em>
                </div>
        ...
        <div class="cms_right_box2">
            ...
            <div class="cms_right_box2_title">
                ...
                <div class="cms_right_box2_title_right"><a href="<?php echo U('add'); ?>"><img src="<?php echo __STATIC__; ?>/cms/images/add.png" />新增货架商品位置</a></div>
                        ...
                        <section id="no-more-tables">
                            <table class="table table-bordered table-striped table-condensed cf table-hover">
                                ...
                                <tr>
                                    ...
                                    <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">货架名</th>
                                    <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">商品ID</th>
                                    <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">商品名</th>
                                    <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">位置横坐标</th>
                                    <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">位置纵坐标</th>
                                    <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">库存数量</th>
                                ...
                                <tr>
                                    ...
                                    <td data-title="货架ID" title="<?php echo $list['machine_id']; ?>"><?php echo $list['machine_id']; ?>&nbsp;</td>
                                    <td data-title="货架名" title="<?php echo $list['machine_name']; ?>"><?php echo $list['machine_name']; ?>&nbsp;</td>
                                    <td data-title="商品ID" title="<?php echo $list['product_id']; ?>"><?php echo $list['product_id']; ?>&nbsp;</td>
                                    <td data-title="商品名" title="<?php echo $list['product_name']; ?>"><?php echo $list['product_name']; ?>&nbsp;</td>
                                    <td data-title="位置横坐标" title="<?php echo $list['location_x']; ?>"><?php echo $list['location_x']; ?>&nbsp;</td>
                                    <td data-title="位置纵坐标" title="<?php echo $list['location_y']; ?>"><?php echo $list['location_y']; ?>&nbsp;</td>
                                    <td data-title="库存数量" title="<?php echo $list['storage']; ?>"><?php echo $list['storage']; ?>&nbsp;</td>
