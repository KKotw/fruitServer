<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"/var/www/html/fruit_machine/application/cms/view/cms_model/index.html";i:1481021465;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_header.html";i:1481021471;s:80:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_pager.html";i:1481021471;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_footer.html";i:1481021471;}*/ ?>
		...
		if($('.loginout').css('display')=='block'){
            ...
            <div class="cms_right_box1">
                <form id="searchFrom" action='<?php echo U("index"); ?>' method='get'>
                    ...
                    <div class="cms_right_box1_inner">
                        <em><span>菜单名称</span><input  name="menuname" value="<?php echo (isset($menuname) && ($menuname !== '')?$menuname:""); ?>" /></em>
                        <em><span>模块名称</span><input  name="modelname" value="<?php echo (isset($modelname) && ($modelname !== '')?$modelname:""); ?>"/></em>
                    </div>
            ...
            <div class="cms_right_box2">
                <div class="cms_right_box2_title">
                    <div class="cms_right_box2_title_right"><a href="<?php echo U('update'); ?>"><img src="<?php echo __STATIC__; ?>/cms/images/add.png" />新增模块</a></div>
                </div>
                ...
                <section id="no-more-tables">
                    <table class="table table-bordered table-striped table-condensed cf table-hover">
                        ...
                        <tr>
                            ...
                            <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">菜单名称</th>
                            <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">上级菜单名称</th>
                            <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">模块名称</th>
                        ...
                        <tr>
                            ...
                            <td data-title="菜单名称" title="<?php echo $list['menuname']; ?>"><?php echo $list['menuname']; ?>&nbsp;</td>
                            <td data-title="上级菜单名称" title="<?php echo $list['dm_name']; ?>"><?php echo $list['dm_name']; ?>&nbsp;</td>
                            <td data-title="模块名称" title="<?php echo $list['modelname']; ?>"><?php echo $list['modelname']; ?>&nbsp;</td>
