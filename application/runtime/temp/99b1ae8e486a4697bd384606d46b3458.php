<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"/var/www/html/fruit_machine/application/cms/view/fruit_common_configs/index.html";i:1481021467;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_header.html";i:1481021471;s:80:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_pager.html";i:1481021471;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_footer.html";i:1481021471;}*/ ?>
	...
	$('.showLoginout').click(function(){
        ...
        <div class="cms_right_box2">
            ...
            <div class="cms_right_box2_title">
                ...
                <!--<div class="cms_right_box2_title_right"><a href="<?php echo U('add'); ?>"><img src="<?php echo __STATIC__; ?>/cms/images/add.png" />新增公共变量</a></div>-->
                        ...
                        <section id="no-more-tables">
                            <table class="table table-bordered table-striped table-condensed cf table-hover">
                                ...
                                <tr>
                                    ...
                                    <td data-title="变量名" title="<?php echo $list['name']; ?>"><?php echo $list['name']; ?>&nbsp;</td>
                                    <td data-title="变量描述" title="<?php echo $list['description']; ?>"><?php echo $list['description']; ?>&nbsp;</td>
                                    <td data-title="变量值" title='<?php echo $list['value']; ?>'><?php echo $list['value']; ?>&nbsp;</td>
                                    <td data-title="配置类型 0：string ，1：bannerUrl，2：file，3：files" title="<?php echo $list['type']; ?>">
                                        <?php if($list['type']==0): ?>string<?php elseif($list['type']==1): ?>bannerUrl<?php elseif($list['type']==2): ?>file<?php else: ?>files<?php endif; ?></td>
