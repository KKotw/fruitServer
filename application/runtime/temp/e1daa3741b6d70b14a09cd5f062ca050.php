<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"/var/www/html/fruit_machine/application/cms/view/cms_module/index.html";i:1481021466;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_header.html";i:1481021471;s:80:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_pager.html";i:1481021471;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_footer.html";i:1481021471;}*/ ?>
		...
		if($('.loginout').css('display')=='block'){
            ...
            <div class="cms_right_box1">
                <form id="searchFrom" action='<?php echo U("index"); ?>' method='get'>
                    ...
                    <div class="cms_right_box1_inner">
                        <em><span>ID</span><input type="text"  name="id" value="<?php echo (isset($id) && ($id !== '')?$id:""); ?>" /></em>
                        <em><span>名称</span><input type="text"  name="name" value="<?php echo (isset($name) && ($name !== '')?$name:""); ?>"/></em>
                    </div>
            ...
            <div class="cms_right_box2">
                <div class="cms_right_box2_title">
                    <div class="cms_right_box2_title_right"><a href="<?php echo U('add'); ?>"><img src="<?php echo __STATIC__; ?>/cms/images/add.png" />新增大模块</a></div>
                </div>
                ...
                <section id="no-more-tables">
                    <table class="table table-bordered table-striped table-condensed cf table-hover">
                        ...
                        <tr>
                            ...
                            <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">名称</th>
                        ...
                        <tr>
                            ...
                            <td data-title="名称" title="<?php echo $list['name']; ?>"><?php echo $list['name']; ?>&nbsp;</td>
                            <td data-title="状态" title="<?php echo showstatus($list['status'],'正常,删除:0,4'); ?>"><?php echo showstatus($list['status'],'正常,删除:0,4'); ?>&nbsp;</td>
<!--                             <td class="width_limit" data-title="分配模块" style="height: 40px;">
                                <a href="<?php echo U('setmodel',array('id'=>$list['id'])); ?>" class="cms_list_edit"></a>
                            </td> -->
                            <td class="width_limit" data-title="操作" style="height: 40px;">
                                <a href="<?php echo U('edit',array('id'=>$list['id'])); ?>" class="cms_list_edit"></a>
...
<script>
    $(function(){
        ...
        $('#resetval').click(function(){
            ...
            $('#searchFrom').find('select[name="pageSize"]').val('25');
