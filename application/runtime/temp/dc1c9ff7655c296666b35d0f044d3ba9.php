<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/var/www/html/fruit_machine/application/cms/view/fruit_machine/info.html";i:1481021468;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_header.html";i:1481021471;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_footer.html";i:1481021471;}*/ ?>
                ...
                <div class="cms_right_box2_write">
                    <div class="cms_right_box2_write_inner">
                        ...
                        <div class="cms_right_box2_write_group1">
                            <label><span style="color:red">*</span>货架ID</label>
                            <div class="cms_right_box2_write_group1_inner1">        
                                <input id="id" name="id" type="number" value="<?php echo (isset($info['id']) && ($info['id'] !== '')?$info['id']:''); ?>" disabled/>
                            </div>
                        </div>
<!-- input -->
                        <div class="cms_right_box2_write_group1">
                            ...
                            <div class="cms_right_box2_write_group1_inner1">      
                                <input  id="name" name="name" type="text" value='<?php echo (isset($info['name']) && ($info['name'] !== '')?$info['name']:''); ?>' disabled/>
                            </div>
                        </div>
<!-- input -->
                        <div class="cms_right_box2_write_group1">
                            ...
                            <div class="cms_right_box2_write_group1_inner1">      
                                <input  id="contact_name" name="contact_name" type="text" value='<?php echo (isset($info['contact_name']) && ($info['contact_name'] !== '')?$info['contact_name']:''); ?>' disabled/>
                            </div>
                        </div>
<!-- input -->
                        <div class="cms_right_box2_write_group1">
                            ...
                            <div class="cms_right_box2_write_group1_inner1">      
                                <input  id="contact_mobile" name="contact_mobile" type="text" value='<?php echo (isset($info['contact_mobile']) && ($info['contact_mobile'] !== '')?$info['contact_mobile']:''); ?>' disabled/>
                            </div>
                        </div>
<!-- input -->
                        <div class="cms_right_box2_write_group1">
                            ...
                            <div class="cms_right_box2_write_group1_inner1">      
                                <input  id="contact_address" name="contact_address" type="text" value='<?php echo (isset($info['contact_address']) && ($info['contact_address'] !== '')?$info['contact_address']:''); ?>' disabled/>
                            </div>
                        </div>
<!-- input -->
                        <div class="cms_right_box2_write_group1">
                            ...
                            <div class="cms_right_box2_write_group1_inner1">      
                                <input  id="mac" name="mac" type="text" value='<?php echo (isset($info['mac']) && ($info['mac'] !== '')?$info['mac']:''); ?>' disabled/>
                            </div>
                        </div>
                            ...
                            <div class="cms_right_box2_write_group1">
                                ...
                                <div class="cms_right_box2_write_group1_inner5">
                                    <b>
                                        <img  src="<?php echo __STATIC__; ?>/qrcode/<?php echo $info['id']; ?>.png" />
                                    </b>
                                </div>
                            </div>
                        ...
                        <div class="cms_right_box2_write_group1">
                            ...
                            <div class="cms_right_box2_write_group1_inner1">
                                <input  id="is_delete" name="is_delete" type="text" value='<?php if($info['is_delete']==1): ?>删除<?php else: ?>正常<?php endif; ?>'/>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function initFileUpload(fieldClick,fieldUp,fieldValue,fieldView){
            ...
            $(fieldUp).fileupload({
                autoUpload:true,
                url:'<?php echo U("upload/fileupload"); ?>?photodir=fruit_machine',
                dataType:'json',
        ...
        function initKindEditor(field) {
            KindEditor.ready(function(K) {
                editor = K.create('#'+field, {
                    ...
                    uploadJson : '<?php echo U("upload/kindEditorUpload"); ?>?photodir=fruit_machine_text',
                    height:350,
                    width:'100%',
                    items : [
