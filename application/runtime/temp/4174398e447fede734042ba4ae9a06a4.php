<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/var/www/html/fruit_machine/application/cms/view/fruit_order_detail/index.html";i:1481021469;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_header.html";i:1481021471;s:80:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_pager.html";i:1481021471;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_footer.html";i:1481021471;}*/ ?>
            ...
            <div class="cms_right_box1">
                <form id="searchFrom" action='<?php echo U("index"); ?>' method='get'>
                    ...
                    <div class="cms_right_box1_inner">
                        ...
                        <em><span>订单ID</span><input name="order_id" value='<?php echo (isset($searchCnd['order_id']) && ($searchCnd['order_id'] !== '')?$searchCnd['order_id']:""); ?>'></em>
                </div>
                        ...
                        <section id="no-more-tables">
                            <table class="table table-bordered table-striped table-condensed cf table-hover">
                                ...
                                <tr>
                                    ...
                                    <td data-title="订单ID" title="<?php echo $list['order_id']; ?>"><?php echo $list['order_id']; ?>&nbsp;</td>
                                    ...
                                    <td data-title="产品ID" title="<?php echo $list['product_id']; ?>"><?php echo $list['product_id']; ?>&nbsp;</td>
                                    <td data-title="产品名" title="<?php echo $list['product_name']; ?>"><?php echo $list['product_name']; ?>&nbsp;</td>
                                    <td data-title="产品购买数" title="<?php echo $list['product_count']; ?>"><?php echo $list['product_count']; ?>&nbsp;</td>
                                    <td data-title="该产品总支付额" title='<?php echo number_format($list['price'],2); ?>'><?php echo number_format($list['price'],2); ?>&nbsp;</td>
