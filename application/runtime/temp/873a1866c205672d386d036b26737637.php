<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"/var/www/html/fruit_machine/application/cms/view/fruit_order/index.html";i:1481021468;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_header.html";i:1481021471;s:80:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_pager.html";i:1481021471;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_footer.html";i:1481021471;}*/ ?>
            ...
            <div class="cms_right_box1">
                <form id="searchFrom" action='<?php echo U("index"); ?>' method='get'>
                    ...
                    <div class="cms_right_box1_inner">
                        <em><span>订单ID</span><input name="id" value='<?php echo (isset($searchCnd['id']) && ($searchCnd['id'] !== '')?$searchCnd['id']:""); ?>'></em>
                        <em><span>订单号</span><input name="order_number" value='<?php echo (isset($searchCnd['order_number']) && ($searchCnd['order_number'] !== '')?$searchCnd['order_number']:""); ?>'></em>
                        <em><span>用户名</span><input name="nickname" value='<?php echo (isset($searchCnd['nickname']) && ($searchCnd['nickname'] !== '')?$searchCnd['nickname']:""); ?>'></em>
                        <em><span>订单状态</span>
                            <select name="status">
                                <option value="0">全部</option>
                                <option value="1" <?php if($searchCnd['status'] == 1): ?>selected<?php endif; ?>>已支付</option>
                                <option value="2" <?php if($searchCnd['status'] == 2): ?>selected<?php endif; ?>>出货中</option>
                                <option value="3" <?php if($searchCnd['status'] == 3): ?>selected<?php endif; ?>>出货成功</option>
                            </select>
                        </em>
                </div>
                        ...
                        <section id="no-more-tables">
                            <table class="table table-bordered table-striped table-condensed cf table-hover">
                                ...
                                <tr>
                                    ...
                                    <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">订单号</th>
                                    <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">支付总价</th>
                                    <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">产品名</th>
                                    <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">订单状态</th>
                                    <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">未使用次数</th>
                                    <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">创建时间</th>
                                    <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">订单明细</th>
                                ...
                                <tr>
                                    ...
                                    <!--<td data-title="用户ID" title="<?php echo $list['user_id']; ?>"><?php echo $list['user_id']; ?>&nbsp;</td>-->
                                    <td data-title="用户名" title="<?php echo $list['user_id']; ?>"><?php echo $list['nickname']; ?>&nbsp;</td>
                                    <td data-title="订单号" title="<?php echo $list['order_number']; ?>"><?php echo $list['order_number']; ?>&nbsp;</td>
                                    <td data-title="支付总价" title="<?php echo number_format($list['total_price'],2); ?>"><?php echo number_format($list['total_price'],2); ?>&nbsp;</td>
                                    <td data-title="产品名连接" title="<?php echo $list['products']; ?>"><?php echo $list['products']; ?>&nbsp;</td>
                                    <td data-title="订单状态" title="<?php echo $list['status']; ?>"><?php switch($list['status']): case "0": ?>未支付<?php break; case "1": ?>已支付<?php break; case "2": ?>出货中<?php break; case "3": ?>出货成功<?php break; endswitch; ?></td>
                                    <td data-title="未使用次数" title="<?php echo $list['left_count']; ?>"><?php echo $list['left_count']; ?></td>
                                    <td data-title="创建时间" title="<?php echo $list['createtime']; ?>"><?php echo $list['createtime']; ?>&nbsp;</td>
                                    <td><a  href="<?php echo U('cms/FruitOrderDetail/index',array('order_id'=>$list['id'])); ?>" >订单明细</a></td>
