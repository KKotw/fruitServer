<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/var/www/html/fruit_machine/application/cms/view/fruit_location/add.html";i:1481021467;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_header.html";i:1481021471;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_footer.html";i:1481021471;}*/ ?>
            ...
            <div class="cms_right_box2">
                <div class="cms_right_box2_write">
                    <div class="cms_right_box2_write_inner">
                        <form class="cmxform form-horizontal adminex-form" id="addForm" action="<?php echo U('add'); ?>" method="post">
                        <div class="cms_right_box2_write_group1">
                            ...
                            <div class="cms_right_box2_write_group1_inner1">                                        
                                <select  id='machine_id' name = 'machine_id' <?php if(isset($_GET['machine_id'])): ?> readonly  <?php endif; ?>>
                                <?php echo getfkarr('id,name,is_delete','fruit_machine','',$arr,0); if(isset($arr)): foreach($arr as $k=>$list): if($list['is_delete']==0): ?>
                                    <option value="<?php echo $list['id']; ?>" <?php if(isset($_GET['machine_id'])): ?> <?php echo ($list['id']==$_GET['machine_id'])?'selected' : ''; endif; ?>><?php echo $list['name']; ?></option>
                        ...
                        <div class="cms_right_box2_write_group1">
                            ...
                            <div class="cms_right_box2_write_group1_inner1">                                        
                                <select  id='product_id' name = 'product_id' <?php if(isset($_GET['product_id'])): ?> readonly  <?php endif; ?>>
                                <?php echo getfkarr('id,name,is_delete','fruit_product','',$arr,0); if(isset($arr)): foreach($arr as $k=>$list): if($list['is_delete']==0): ?>
                                    <option value="<?php echo $list['id']; ?>" <?php if(isset($_GET['product_id'])): ?> <?php echo ($list['id']==$_GET['product_id'])?'selected' : ''; endif; ?>><?php echo $list['name']; ?></option>
                                <?php endif; endforeach; endif; ?>
                                </select>
                            </div>
                        </div>
