<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"/var/www/html/fruit_machine/application/cms/view/cms_user/index.html";i:1481021466;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_header.html";i:1481021471;s:80:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_pager.html";i:1481021471;s:81:"/var/www/html/fruit_machine/public/../application/cms/view/layout/new_footer.html";i:1481021471;}*/ ?>
		...
		if($('.loginout').css('display')=='block'){
            ...
            <div class="cms_right_box1">
                <form id="searchFrom" action='<?php echo U("index"); ?>' method='get'>
                    ...
                    <div class="cms_right_box1_inner">
                        <em><span>用户名称</span><input  name="username" value="<?php echo (isset($username) && ($username !== '')?$username:""); ?>" /></em>
                    </div>
            ...
            <div class="cms_right_box2">
                <div class="cms_right_box2_title">
                    <div class="cms_right_box2_title_right"><a href="<?php echo U('update'); ?>"><img src="<?php echo __STATIC__; ?>/cms/images/add.png" />新增用户</a></div>
                </div>
                ...
                <section id="no-more-tables">
                    <table class="table table-bordered table-striped table-condensed cf table-hover">
                        ...
                        <tr>
                            ...
                            <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">用户名称</th>
                            <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">用户角色</th>
                            <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">重置密码</th>
                            <th style="border-bottom: 1px solid #ddd;border-right: 1px solid #ddd;">分配角色</th>
                        ...
                        <tr>
                            ...
                            <td data-title="用户名称" title="<?php echo $list['username']; ?>"><?php echo $list['username']; ?>&nbsp;</td>
                            <td data-title="用户角色" title="<?php echo $list['rolename']; ?>"><?php echo $list['rolename']; ?>&nbsp;</td>
                            <td class="width_limit" data-title="重置密码" style="height: 40px;">
                                <a href="<?php echo U('resetpassword',array('id'=>$list['id'])); ?>" class="cms_list_edit"></a>
                            </td>
                            <td class="width_limit" data-title="分配角色" style="height: 40px;">
                                <a href="<?php echo U('setrole',array('id'=>$list['id'])); ?>" class="cms_list_edit"></a>
                            </td>
